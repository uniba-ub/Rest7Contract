...
* **/orcid/publications** - to update the preference relative to the publications synchronization; allowed values are 'DISABLED', 'ALL', 'MINE' and 'MY_SELECTED'
* **/orcid/projects** - to update the preference relative to the projects synchronization; allowed values are 'DISABLED', 'ALL', 'MINE' and 'MY_SELECTED'
